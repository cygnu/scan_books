    ...
    return _then(_value.copyWith(
      ...
      industryIdentifiers: industryIdentifiers == freezed
          ...
          : industryIdentifiers // ignore: cast_nullable_to_non_nullable
              as List<GoogleBookIndustryIdentifiersResponse>,
...
/// @nodoc
@JsonSerializable()
class _$_GoogleBookVolumeInfoResponse extends _GoogleBookVolumeInfoResponse
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'GoogleBookVolumeInfoResponse(title: $title, publisher: $publisher, publishedDate: $publishedDate, description: $description, industryIdentifiers: $industryIdentifiers, pageCount: $pageCount, imageLinks: $imageLinks, infoLink: $infoLink)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _GoogleBookVolumeInfoResponse &&
            ...
            (identical(other.industryIdentifiers, industryIdentifiers) ||
                const DeepCollectionEquality()
